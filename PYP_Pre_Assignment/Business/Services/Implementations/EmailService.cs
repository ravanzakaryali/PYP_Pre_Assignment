...
namespace Business.Services.Implementations
{
    public class EmailService : IEmailService
    {
        ...
        public async Task SendEmailAsync(string subject, List<EmailDto> emails, string attachmentPath)
        {
            var apiKey = Environment.GetEnvironmentVariable(_configuration["SendGrid:ApiKey"]);
